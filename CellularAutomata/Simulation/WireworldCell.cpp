...
WireworldCell::WireworldCell() : Entity()
{
	...
	mElectronHeadTexture = TextureCache::GetTexture("Textures/ElectronHead.bmp");
	mElectronTailTexture = TextureCache::GetTexture("Textures/ElectronTail.bmp");
	mConductorTexture = TextureCache::GetTexture("Textures/Conductor.bmp");
}
